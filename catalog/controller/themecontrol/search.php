...
class ControllerthemecontrolSearch extends Controller {
	...
	public function index( $setting ) { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/themecontrol/search.tpl')) {
			$template = $this->config->get('config_template') . '/template/themecontrol/search.tpl';
		} else {
