...
class ModelPresencePresence extends Model {
	...
	public function addLogSchedule($customer_id, $date, $time_in, $time_out) {
		$sql = "INSERT INTO " . DB_PREFIX . "presence_log SET customer_id = '" . (int)$customer_id . "', date = '" . $this->db->escape($date) . "', time_in = '" . $this->db->escape($time_in) . "', time_out = '" . $this->db->escape($time_out) . "', time_login = '0000-00-00 00:00:00', time_logout = '0000-00-00 00:00:00'";
