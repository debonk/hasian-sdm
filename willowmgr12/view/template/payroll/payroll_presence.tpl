          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-left"><?php echo $payroll['period']; ?></td>
                  <td class="text-left"><?php echo $payroll['date_start']; ?></td>
                  <td class="text-left"><?php echo $payroll['date_end']; ?></td>
                  <td class="text-left"><?php echo $payroll['payroll_status']; ?></td>
                  <td class="text-right"><a href="<?php echo $payroll['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a> <a href="<?php echo $payroll['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                    <button type="button" value="<?php echo $payroll['payroll_id']; ?>" id="button-delete<?php echo $payroll['payroll_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></button></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
