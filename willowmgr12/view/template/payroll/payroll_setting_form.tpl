	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form method="post" action="<?php echo $action; ?>" enctype="multipart/form-data" id="form-payroll-setting"
					...
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab-presence-status" data-toggle="tab">
								<?php echo $tab_presence_status; ?>
							</a></li>
						<li><a href="#tab-payroll-status" data-toggle="tab">
								<?php echo $tab_payroll_status; ?>
							</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							<div class="form-group">
								<label class="col-sm-2 control-label"><span data-toggle="tooltip"
										title="<?php echo $help_presence_lock; ?>">
										<?php echo $entry_presence_lock; ?>
									</span></label>
								<div class="col-sm-10">
										...
										<div class="checkbox">
											<label>
												...
												<input type="checkbox" name="payroll_setting_presence_lock[]"
													value="<?php echo $location['location_id']; ?>" checked="checked" />
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-default-hke"><span data-toggle="tooltip"
										title="<?php echo $help_default_hke; ?>">
										<?php echo $entry_default_hke; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_default_hke"
										value="<?php echo $payroll_setting_default_hke; ?>" class="form-control" id="input-default-hke" />
									<?php if ($error_default_hke) { ?>
									<div class="text-danger">
										<?php echo $error_default_hke; ?>
									</div>
									<?php } ?>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-vacation-limit"><span data-toggle="tooltip"
										title="<?php echo $help_vacation_limit; ?>">
										<?php echo $entry_vacation_limit; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_vacation_limit"
										value="<?php echo $payroll_setting_vacation_limit; ?>" class="form-control"
										id="input-vacation-limit" />
									<?php if ($error_vacation_limit) { ?>
									<div class="text-danger">
										<?php echo $error_vacation_limit; ?>
									</div>
									<?php } ?>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-logout-date"><span data-toggle="tooltip"
										title="<?php echo $help_logout_date; ?>">
										<?php echo $entry_logout_date; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_logout_date"
										value="<?php echo $payroll_setting_logout_date; ?>" class="form-control" id="input-logout-date" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-login-start"><span data-toggle="tooltip"
										title="<?php echo $help_login_start; ?>">
										<?php echo $entry_login_start; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_login_start"
										value="<?php echo $payroll_setting_login_start; ?>" class="form-control" id="input-login-start" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-login-end"><span data-toggle="tooltip"
										title="<?php echo $help_login_end; ?>">
										<?php echo $entry_login_end; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_login_end" value="<?php echo $payroll_setting_login_end; ?>"
										class="form-control" id="input-login-end" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-logout-start"><span data-toggle="tooltip"
										title="<?php echo $help_logout_start; ?>">
										<?php echo $entry_logout_start; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_logout_start"
										value="<?php echo $payroll_setting_logout_start; ?>" class="form-control" id="input-logout-start" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><span data-toggle="tooltip"
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-completed-after"><span data-toggle="tooltip"
										title="<?php echo $help_completed_after; ?>">
										<?php echo $entry_completed_after; ?>
									</span></label>
								<div class="col-sm-10">
									<input type="text" name="payroll_setting_completed_after"
										value="<?php echo $payroll_setting_completed_after; ?>" class="form-control"
						...
						<div class="tab-pane" id="tab-presence-status">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-status-<?php echo $presence_item; ?>">
									<?php echo $entry_status[$presence_item]; ?>
								</label>
								<div class="col-sm-10">
									<select name="payroll_setting_id_<?php echo $presence_item; ?>"
										id="input-status-<?php echo $presence_item; ?>" class="form-control">
										...
										<option value="<?php echo $presence_status['presence_status_id']; ?>" selected="selected">
							...
							<div class="form-group required">
								<label class="col-sm-2 control-label"><span data-toggle="tooltip"
										title="<?php echo $help_presence_statuses; ?>">
										<?php echo $entry_presence_statuses; ?>
									</span></label>
								<div class="col-sm-10">
									<div class="well well-sm" style="height: 150px; overflow: auto;">
										<?php foreach ($presence_statuses as $presence_status) { ?>
											...
											<div class="checkbox">
												<label>
													...
													<input type="checkbox" name="payroll_setting_presence_status_ids[]"
														value="<?php echo $presence_status['presence_status_id']; ?>" checked="checked" />
													<?php echo $presence_status['name']; ?>
													<?php } else { ?>
													<input type="checkbox" name="payroll_setting_presence_status_ids[]"
														value="<?php echo $presence_status['presence_status_id']; ?>" />
													<?php echo $presence_status['name']; ?>
													<?php } ?>
												</label>
											</div>
						...
						<div class="tab-pane" id="tab-payroll-status">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-pending-status"><span data-toggle="tooltip"
										title="<?php echo $help_pending_status; ?>">
								...
								<div class="col-sm-10">
									<select name="payroll_setting_pending_status_id" id="input-pending-status" class="form-control">
										...
										<option value="<?php echo $payroll_status['payroll_status_id']; ?>" selected="selected">
											<?php echo $payroll_status['name']; ?>
										</option>
										<?php } else { ?>
										<option value="<?php echo $payroll_status['payroll_status_id']; ?>">
											<?php echo $payroll_status['name']; ?>
										</option>
										<?php } ?>
										<?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-processing-status"><span data-toggle="tooltip"
										title="<?php echo $help_processing_status; ?>">
										<?php echo $entry_processing_status; ?>
									</span></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-submitted-status"><span data-toggle="tooltip"
										title="<?php echo $help_submitted_status; ?>">
										<?php echo $entry_submitted_status; ?>
									</span></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-generated-status"><span data-toggle="tooltip"
										title="<?php echo $help_generated_status; ?>">
										<?php echo $entry_generated_status; ?>
									</span></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-approved-status"><span data-toggle="tooltip"
										title="<?php echo $help_approved_status; ?>">
										<?php echo $entry_approved_status; ?>
									</span></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-released-status"><span data-toggle="tooltip"
										title="<?php echo $help_released_status; ?>">
										<?php echo $entry_released_status; ?>
									</span></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-completed-status"><span data-toggle="tooltip"
										title="<?php echo $help_completed_status; ?>">
