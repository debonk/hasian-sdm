      ...
      <div class="row">
		        ...
		        <table class="table table-bordered">
		          <thead>
		        	<tr>
		        	  ...
		        	  <td class="text-center"><?php echo $column_time_start; ?></td>
		        	  <td class="text-center"><?php echo $column_time_end; ?></td>
		        	</tr>
		          </thead>
		          <tbody>
		      	  <?php foreach ($schedule_types as $schedule_type) { ?>
		        	<tr>
		        	  <td class="text-center"><?php echo $schedule_type['code']; ?></td>
		        	  <td class="text-center"><?php echo $schedule_type['time_start']; ?></td>
		        	  <td class="text-center"><?php echo $schedule_type['time_end']; ?></td>
		        	</tr>
		      	  <?php } ?>
		          </tbody>
		        </table>
          ...
          <div class="panel-body col-sm-7">
		    ...
		    <div class="table-responsive">
		      <table class="table table-bordered">
		        ...
		        <tbody>
		      	  <tr>
		      	    ...
		      	    <td class="text-center"><?php echo $presence_summary['h']; ?></td>
		      	    <td class="text-center"><?php echo $presence_summary['s']; ?></td>
		      	    <td class="text-center"><?php echo $presence_summary['i']; ?></td>
		      	    <td class="text-center"><?php echo $presence_summary['ns']; ?></td>
		      	    <td class="text-center"><?php echo $presence_summary['ia']; ?></td>
		      	    <td class="text-center"><?php echo $presence_summary['a']; ?></td>
		      	    <td class="text-center"><?php echo $presence_summary['c']; ?></td>
		  		    <?php } else { ?>
		      ...
		      <table class="table table-bordered">
		        <thead>
		    	  <tr>
		    	    <td class="text-center table-evenly-4"><?php echo $column_t; ?></td>
		        ...
		        <tbody>
		    	  <tr>
				    <?php if ($presence_summary) { ?>
		    	    <td class="text-center"><?php echo $presence_summary['t']; ?></td>
		    	    <td class="text-center"><?php echo $presence_summary['t1']; ?></td>
		    	    <td class="text-center"><?php echo $presence_summary['t2']; ?></td>
		    	    <td class="text-center"><?php echo $presence_summary['t3']; ?></td>
				    <?php } else { ?>
        ...
        <div class="col-sm-12">
          <form action="<?php echo $edit; ?>" method="post" enctype="multipart/form-data" id="form-presence-summary" class="form-horizontal">
		    <legend><?php echo $text_schedule_detail; ?></legend>
			<div class="table-responsive">
			  <table class="table table-bordered">
			    <thead>
			  	<tr>
				  ...
				  <?php for ($week = 0; $week < $total_week; $week++) { ?>
				      ...
				      <?php for ($day = 0; $day < 7; $day++) { ?>
				        <?php if (isset($calendar[$week . $day])) { ?>
						    ...
						    <?php } else { ?>
						    <select name="<?php echo 'schedule' . $calendar[$week . $day]['date']; ?>" id="" class="form-control">
          ...
          <div class="panel-body">
		    <legend><?php echo $text_log; ?></legend>
		    <div class="table-responsive">
		      <table class="table table-bordered">
		        <thead>
		      	<tr>
		        ...
		        <tbody>
		      	...
		      	<tr>
		      	  <td class="text-left"><?php echo $calendar_data['text']; ?></td>
