					...
					<div class="flex-container">
						...
						<div class="flex-item">
							<div class="form-group">
								...
								<select name="filter[presence_status_id]" id="input-presence-status"
									class="form-control">
									<option value="*">
										<?= $text_all ?>
									</option>
						...
						<table class="table table-bordered table-hover text-left">
							<thead>
								<tr>
									...
									<td>
										<a href="<?= $sort_presence_status; ?>" <?=($sort=='presence_status' )
											? 'class="' . strtolower($order) . '"' : '' ; ?> >
								...
								<tr>
									...
									<td class="text-center">
										...
										<button type="button" id="button-approve<?= $absence['absence_id']; ?>"
											value="<?= $absence['absence_id']; ?>"
											data-loading-text="<?= $text_loading; ?>" class="btn btn-warning btn-xs"><i
												class="fa fa-check"></i>
											<?= $button_approve; ?>
										</button>
										<?php } ?>
									...
									<td class="text-right">
										<a href="<?= $absence['edit']; ?>" data-toggle="tooltip"
