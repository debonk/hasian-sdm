    ...
    <div class="container-fluid">
      <div class="pull-right">
		<?php if ($submitted_status_check) { ?>
		  <button type="button" id="button-export" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default"><i class="fa fa-upload"></i> <?php echo $button_export; ?></button>
		<?php } else { ?>
		  <button type="button" id="button-export" class="btn btn-default disabled"><i class="fa fa-upload"></i> <?php echo $button_export; ?></button>
		<?php } ?>	
		<?php if ($payroll_status_check) { ?>
		  <button type="button" value="<?php echo $presence_period_id; ?>" id="button-presence-submit" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-warning"><i class="fa fa-share-square-o"></i> <?php echo $button_presence_submit; ?></button>
          <button type="button" id="button-delete" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-presence-total').submit() : false;"><i class="fa fa-trash-o"></i></button>
        <?php } else { ?>
		  <button type="button" value="" class="btn btn-warning disabled"><i class="fa fa-share-square-o"></i> <?php echo $button_presence_submit; ?></button>
      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-payroll-include"><?php echo $entry_payroll_include; ?></label>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-presence-code"><?php echo $entry_presence_status; ?></label>
                <select name="filter_presence_code" id="input-presence-code" class="form-control">
                  ...
                  <option value="<?php echo $presence_status['code']; ?>" selected="selected"><?php echo $presence_status['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $presence_status['code']; ?>"><?php echo $presence_status['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                  <?php } ?>
                </select>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left" rowspan="2"><?php if ($sort == 'location') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center" colspan="12"><?php echo $column_presence_summary; ?></td>
                  <td class="text-right" rowspan="2"><?php echo $column_action; ?></td>
                </tr>
				  <tr>
					<td class="text-center presence-summary"><?php echo $column_hke; ?></td>
					<td class="text-center presence-summary"><?php echo $column_h; ?></td>
					<td class="text-center presence-summary"><?php echo $column_s; ?></td>
					<td class="text-center presence-summary"><?php echo $column_i; ?></td>
					<td class="text-center presence-summary"><?php echo $column_ns; ?></td>
					<td class="text-center presence-summary"><?php echo $column_ia; ?></td>
					<td class="text-center presence-summary"><?php echo $column_a; ?></td>
					<td class="text-center presence-summary"><?php echo $column_c; ?></td>
					<td class="text-center presence-summary"><?php echo $column_t1; ?></td>
					<td class="text-center presence-summary"><?php echo $column_t2; ?></td>
					<td class="text-center presence-summary"><?php echo $column_t3; ?></td>
              ...
              <tbody>
                ...
                <td class="text-center"><?php echo $customer['hke']; ?></td>
                <td class="text-center"><?php echo $customer['total_h']; ?></td>
                <td class="text-center"><?php echo $customer['total_s']; ?></td>
                <td class="text-center"><?php echo $customer['total_i']; ?></td>
                <td class="text-center"><?php echo $customer['total_ns']; ?></td>
                <td class="text-center"><?php echo $customer['total_ia']; ?></td>
                <td class="text-center"><?php echo $customer['total_a']; ?></td>
                <td class="text-center"><?php echo $customer['total_c']; ?></td>
                <td class="text-center"><?php echo $customer['total_t1']; ?></td>
                <td class="text-center"><?php echo $customer['total_t2']; ?></td>
                <td class="text-center"><?php echo $customer['total_t3']; ?></td>
