          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group"> <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="payroll_status[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($payroll_status[$language['language_id']]) ? $payroll_status[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control" />
              </div>
