    ...
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="button" data-toggle="tooltip" title="<?= $button_delete; ?>" class="btn btn-danger"
          onclick="confirm('<?= $text_confirm; ?>') ? $('#form-loan').submit() : false;"><i
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?= $delete; ?>" method="post" enctype="multipart/form-data" id="form-loan">
            ...
            <table class="table table-bordered table-hover text-left">
              <thead>
                <tr>
                  ...
                  <td>
                    <a href="<?= $sort_date_added; ?>" <?=($sort=='date_added' ) ? 'class="' . strtolower($order) . '"'
                      : '' ; ?> >
                      <?= $column_date_added; ?>
                    </a>
                  </td>
                  ...
                  <td class="text-right">
                    <a href="<?= $sort_balance; ?>" <?=($sort=='balance' ) ? 'class="' . strtolower($order) . '"' : '' ;
                      ?> >
                      <?= $column_balance; ?>
                    </a>
                  </td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center">
                    <?php if (in_array($loan['loan_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?= $loan['loan_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?= $loan['loan_id']; ?>" />
                    <?php } ?>
                  </td>
                  <td>
                    <?= $loan['date_added']; ?>
                  ...
                  <td class="text-right nowrap">
                    <a href="<?= $loan['view']; ?>" data-toggle="tooltip" title="<?= $button_view; ?>"
                      class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="<?= $loan['edit']; ?>" data-toggle="tooltip" title="<?= $button_edit; ?>"
...
<script type="text/javascript">
  ...
  $('#button-filter').on('click', function () {
    url = 'index.php?route=loan/loan&token=<?= $token; ?>';
  ...
  $('input[name=\'filter[name]\']').autocomplete({
    'source': function (request, response) {
      $.ajax({
        url: 'index.php?route=loan/loan/autocomplete&token=<?= $token; ?>&filter_status=0&filter_name=' + encodeURIComponent(request),
        dataType: 'json',
