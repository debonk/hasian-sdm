  ...
  <div class="panel-heading">
    <div class="pull-right"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-calendar"></i> <i class="caret"></i></a>
      <ul id="range" class="dropdown-menu dropdown-menu-right">
        <li><a href="earning"><?php echo $text_earning; ?></a></li>
        <li><a href="deduction"><?php echo $text_deduction; ?></a></li>
        <li class="active"><a href="grandtotal"><?php echo $text_grandtotal; ?></a></li>
      </ul>
    </div>
...
$('#range a').on('click', function(e) {
	...
	$.ajax({
		...
		success: function(json) {
                        if (typeof json['payroll'] == 'undefined') { return false; }
			var option = {	
				shadowSize: 0,
 ...
 */				grid: {
			...
			$.plot('#chart-sale', [json['payroll'], json['customer']], option);	
