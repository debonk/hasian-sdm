    ...
    <div class="container-fluid">
      <div class="pull-right"><a href="<?= $add; ?>" data-toggle="tooltip" title="<?= $button_add; ?>"
        ...
        <button type="button" data-toggle="tooltip" title="<?= $button_delete; ?>" class="btn btn-danger"
          onclick="confirm('<?= $text_confirm; ?>') ? $('#form-user-group').submit() : false;"><i
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center">
                    <?php if (in_array($user_group['user_group_id'], $selected)) { ?>
                  ...
                  <td class="text-right"><a href="<?= $user_group['edit']; ?>" data-toggle="tooltip"
