...
<div id="content">
	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<h4 class="pull-right"><i class="fa fa-calendar"></i>
					<?php echo $period_info; ?>
				</h4>
			</div>
	...
	<script type="text/javascript">
		...
		$('#button-export').on('click', function () {
			url = 'index.php?route=report/payroll/export&token=<?php echo $token; ?>&presence_period_id=<?php echo $presence_period_id; ?>';
	...
	<script type="text/javascript">
		$('#button-filter').on('click', function () {
			url = 'index.php?route=report/payroll&token=<?php echo $token; ?>';
