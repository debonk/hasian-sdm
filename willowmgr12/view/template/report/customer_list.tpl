      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_date_start" value="<?php echo $filter_date_start; ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="MMM YY" id="input-date-added" class="form-control" />
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-date-end"><?php echo $entry_active; ?></label>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.email') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo $column_vacation_count; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $customer['vacation_count']; ?></td>
                  <td class="text-right">
                    <a href="<?php echo $customer['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/customer&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/customer/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
...
$('input[name=\'filter_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/customer/autocomplete&token=<?php echo $token; ?>&filter_email=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
