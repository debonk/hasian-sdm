            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select name="filter_customer_group_id" id="input-customer-group" class="form-control">
                  <option value="*">
                    <?php echo $text_all_customer_group ?>
                  </option>
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right" id="date_added<?php echo $customer['customer_id']; ?>">
                  <?php echo $customer['date_added']; ?>
                </td>
                <td class="text-right" id="username<?php echo $customer['customer_id']; ?>">
                  <?php echo $customer['username']; ?>
                </td>
                <td class="text-right">
                  <?php if ($customer['register']) { ?>
                  <button type="button" value="<?php echo $customer['customer_id']; ?>"
                    id="button-register<?php echo $customer['customer_id']; ?>"
                    data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip"
                    title="<?php echo $button_register; ?>" class="btn btn-primary"><i
                      class="fa fa-barcode"></i></button>
                  <?php } else { ?>
                  <button type="button" value="<?php echo $customer['customer_id']; ?>"
                    id="button-delete<?php echo $customer['customer_id']; ?>"
                    data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip"
                    title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>
                  <button type="button" value="<?php echo $customer['customer_id']; ?>"
                    id="button-verification<?php echo $customer['customer_id']; ?>"
                    data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip"
                    title="<?php echo $button_verification; ?>" class="btn btn-default"><i
                      class="fa fa-sign-in"></i></button>
                  <?php } ?>
                  <a href="<?php echo $customer['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>"
  ...
  <script type="text/javascript">
    $('input[name=\'filter_name\']').autocomplete({
      'source': function (request, response) {
        $.ajax({
          url: 'index.php?route=customer/finger/autocomplete&token=<?php echo $token; ?>&filter_name=' + encodeURIComponent(request),
          dataType: 'json',
