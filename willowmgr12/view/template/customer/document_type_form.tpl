  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-document-type" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-document-type" class="form-horizontal">
          <div class="tab-content">
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-10">
                ...
                <div class="text-info"><?php echo $help_description; ?></div>
              </div>
            </div>
