...
class ModelPresencePresence extends Model {
	public function getCustomers($data = array()) {
		...
		$sql = "SELECT customer_id, nip, name, date_start, date_added, customer_department_id, customer_department, customer_group_id, customer_group, location_id, location FROM " . DB_PREFIX . "v_customer WHERE status = 1";
	...
	public function deletePresence($presence_period_id, $customer_id) {//used by: schedule
	...
	public function addPresenceSummary($presence_period_id, $customer_id, $data) {//used by: schedule
	...
	public function getPresencesCountByPresenceStatusId($presence_status_id) { //Used by localisation/presence_status
