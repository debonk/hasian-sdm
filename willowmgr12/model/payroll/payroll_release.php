...
class ModelPayrollPayrollRelease extends Model {
	public function getPayrollPeriods($data = array()) {//Used by: payroll_release
	...
	public function getTotalPayrollPeriods($data = array()) {//Used by: payroll_release
...
// print_r($sql);
	...
	public function getMethodReleases($presence_period_id) {//Used by: payroll_release
