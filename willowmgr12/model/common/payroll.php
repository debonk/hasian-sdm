...
class ModelCommonPayroll extends Model {
	public function getPeriod($presence_period_id = 0) { //sama dgn model_presence_presence_period->getPresencePeriod($presence_period_id)
	...
	public function getPresenceByDate($customer_id, $date) {//Used by component/overtime
